...
public class Lab16c
{
	public static void main( String args[] )
	{
		...
		System.out.println("beat = "+test.countWordsWithXVowels(2));
		System.out.println("abused = "+test.countWordsWithXVowels(3));
		System.out.println("gorgeous = "+test.countWordsWithXVowels(4));
